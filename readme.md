Delegate Less Builder

A simple nuget package to add MSBuild targets for .less files in your Visual Studio projects. 

There is no manual intervention required; all .less files included in the project will simply be converted to equivalent .css files during build.
